...
import com.anjos_bolos.anjos_bolos_api.core.application.command.cliente.ListClientesByNomeQuery;
import com.anjos_bolos.anjos_bolos_api.core.application.exception.NotFoundException;
import com.anjos_bolos.anjos_bolos_api.core.domain.cliente.Cliente;

import java.util.List;

public class ListClientesByNomeUseCase {

    private final ClienteGateway gateway;

    public ListClientesByNomeUseCase(ClienteGateway gateway) {
        this.gateway = gateway;
    }

    public List<Cliente> execute(ListClientesByNomeQuery query) {
