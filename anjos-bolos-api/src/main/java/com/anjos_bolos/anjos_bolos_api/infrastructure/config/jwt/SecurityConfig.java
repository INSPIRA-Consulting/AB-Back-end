...
public class SecurityConfig {
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http)
        ...
        authenticationManagerBuilder.authenticationProvider(new AuthProvider(authenticationAdapter, passwordEncoder()));
    ...
    public AuthFilter authFilterBean() {
        return new AuthFilter(authenticationAdapter, authUtilBean());
    }

    @Bean
    public TokenJWTManager authUtilBean() {
        return new TokenJWTManager();
    }
